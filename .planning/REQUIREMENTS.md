...
- [x] **OUT-02**: Система определяет конкретную машину, которой заинтересовался клиент
- [x] **OUT-03**: Система автоматически пишет клиенту в WhatsApp первой с информацией о машине
